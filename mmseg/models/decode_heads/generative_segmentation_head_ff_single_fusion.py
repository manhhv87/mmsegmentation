...
class GenerativeSegHeadFFSingleFusion(BaseDecodeHead):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(GenerativeSegHeadFFSingleFusion, self).__init__(
            init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
        ...
        self.conv_seg_pixel = nn.Conv2d(
            self.indice_seg_channel, self.num_classes, kernel_size=1)
    ...
    def forward_test(self, inputs, img_metas, gt_semantic_seg, test_cfg):
        ...
        seg_pred = self.decode_from_segmap(
            torch.tensor(rec_segmap), keep_ignore_index=False)
