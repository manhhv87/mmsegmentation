...
class ASPP(nn.Module):
    ...
    def forward(self, feature_map):
        ...
        # x5 = F.upsample(x5, size=(feature_map_h, feature_map_w), mode="bilinear")
        x5 = F.interpolate(x5, size=(feature_map_h, feature_map_w), 
                           mode='bilinear', align_corners=False)   # upsampling operation
...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.pre_conv = ASPP(encoder_channels[-1], decode_channels)
