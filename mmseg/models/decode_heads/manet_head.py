...
class MANET(BaseDecodeHead):
    def __init__(self, **kwargs):
        ...
        self.attention4 = PAM_CAM_Layer(encoder_channels[3])
        self.attention3 = PAM_CAM_Layer(encoder_channels[2])
        self.attention2 = PAM_CAM_Layer(encoder_channels[1])
        self.attention1 = PAM_CAM_Layer(encoder_channels[0])
