...
class AttentionEnhancementModule(BaseModule):
    def __init__(self,
                 in_chan,
                 out_chan,
                 conv_cfg=None,
...
class ContextPath(BaseModule):
    ...
    def __init__(self,
        ...
        self.arm16 = AttentionEnhancementModule(context_channels[1],
                                                context_channels[0])
        self.arm32 = AttentionEnhancementModule(context_channels[2],
                                                context_channels[0])
...
class FeatureAggregationModule(BaseModule):
    """
    Args:
        in_channels (int): The number of input channels.
        out_channels (int): The number of output channels.
    Returns:
        feat_out (torch.Tensor): Feature map of Attention Refinement Module.
    """
    ...
    def __init__(self,
        ...
        self.conv_atten = Attention(out_channel)
...
class ABCNet(BaseModule):
    """ABCNet backbone.

    This backbone is the implementation of `ABCNet: Attentive bilateral 
    contextual network for efficient semantic segmentation of 
    Fine-Resolution remotely sensed imagery`_.
